        ...
        <div class="bg-slate-950 pb-20">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <?php if (in_array(get_post_field('post_name', get_the_ID()), ['que-es-wordpress', 'webs-restaurantes-leon-booking', 'seo-local-leon', 'reservas-online-clinicas-leon', 'demo-reservas-restaurantes-leon', 'webs-para-imprentas-leon', 'wpo-wordpress-leon', 'web-restaurantes-leon'], true)) : ?>
                        <?php
                        $post_slug = get_post_field('post_name', get_the_ID());
                        $post_content = apply_filters('the_content', get_the_content());
                        if (in_array($post_slug, ['seo-local-leon', 'reservas-online-clinicas-leon', 'webs-para-imprentas-leon', 'wpo-wordpress-leon', 'web-restaurantes-leon'], true)) {
