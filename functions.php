...
add_action('admin_init', function () {
    ...
    // Post 7: Restaurantes
    $insert_empc_post(
        'Webs para restaurantes en León: Más allá del PDF de la carta',
        'web-restaurantes-leon',
        '<!-- wp:html --> <h1>Webs para restaurantes en León: Más allá del PDF de la carta</h1> <p>En <strong>León</strong>, tu presencia digital es tu primera mesa.</p> <h2>La evolución: Menús interactivos con React</h2> <p>Con el stack <strong>Antigravity</strong>, transformamos tu carta en una experiencia fluida.</p> <div id="island-budget-calculator" class="my-10 p-8 bg-red-50 rounded-3xl border-2 border-red-200"> <h3 class="text-2xl font-bold text-red-900 mb-4">¿Digitalizamos tu cocina?</h3> <div class="p-4 bg-red-800/20 rounded animate-pulse text-center text-red-700">Cargando calculadora Restauración...</div> </div> <!-- /wp:html -->',
        'Digitaliza tu restaurante en León. Menús interactivos y reservas online.',
        'reservas-y-automatizacion',
        '{ "post_type": "blog", "post_id": "web-restaurantes-leon", "seo_keywords": ["web para restaurantes León", "carta digital interactiva León"], "primary_cta": "island-budget-calculator", "island_data": { "calculator_mode": "restaurant-focus", "feature_highlight": "interactive-menu-module" } }'
    );
