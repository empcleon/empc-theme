...
/**
 * Filtro para añadir defer defer (necesario para Vite y módulos ES)
 */
function empc_script_type_module($tag, $handle, $src)
{
    if (in_array($handle, ['vite-client', 'empc-react', 'empc-react-main'])) {
        ...
        // ya que defer defer aísla el scope.
        ...
        return '<script defer defer src="' . esc_url($src) . '"></script>';
    }
    return $tag;
}
//add_filter(add_filter('script_loader_tag', 'empc_script_type_module', 10, 3);47script_loader_tagadd_filter('script_loader_tag', 'empc_script_type_module', 10, 3);47, add_filter('script_loader_tag', 'empc_script_type_module', 10, 3);47empc_script_type_moduleadd_filter('script_loader_tag', 'empc_script_type_module', 10, 3);47, 10, 3);
