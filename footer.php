<footer class="py-20 border-t border-white/5 px-8 bg-[#121826]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <div
            class="p-4 rounded-2xl border border-white/5 bg-white/5 italic text-[10px] text-slate-500 flex items-center gap-2">
            <div class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></div>
            Build: Soberana_v3.0_Stable_DustyRose
        </div>
    </div>
</footer>
<?php wp_footer(); ?>
