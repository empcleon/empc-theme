    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <article class="max-w-7xl mx-auto px-6 py-20">
            ...
            <?php elseif ($slug === 'optimizacion-de-velocidad-wordpress-freelance') : ?>
                <section class="space-y-10">
                    <div class="max-w-4xl space-y-5"><p class="text-[11px] font-bold uppercase tracking-[0.25em] text-[#E29595]">Rendimiento WordPress</p><h1 class="text-4xl md:text-6xl font-bold text-white leading-tight">Optimización de velocidad WordPress</h1><p class="text-xl text-slate-400 leading-relaxed">Reviso la carga, los recursos y la configuración para ofrecer un servicio freelance de optimización WPO para WordPress, con un alcance técnico concreto.</p><a href="<?php echo esc_url(home_url('/contacta-conmigo/?tipo=wpo')); ?>" class="inline-flex min-h-11 items-center justify-center px-6 py-3 rounded-xl bg-[#E29595] text-slate-950 font-bold hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#E29595] focus-visible:ring-offset-[#121826]">Solicitar una valoración</a></div>
                    <section class="space-y-5"><h2 class="text-3xl font-bold text-white">Un servicio con valoración previa</h2><p class="text-slate-400 leading-relaxed">La optimización depende del hosting, tema, plugins, contenidos y objetivos de la web. La valoración inicial define las tareas necesarias.</p><p class="text-slate-400 leading-relaxed">Recibirás una revisión de la carga, los principales cuellos de botella detectados y una propuesta ordenada de mejoras, antes de decidir si quieres aplicarlas.</p><p class="text-2xl font-bold text-[#E29595]">Desde 300 € + IVA</p><p class="text-sm text-slate-400">Proyectos complejos o intervenciones con dependencias externas: presupuesto a medida.</p></section>
                    <section class="rounded-3xl border border-[#E29595]/20 bg-[#E29595]/5 p-6 md:p-8"><a href="<?php echo esc_url(home_url('/contacta-conmigo/?tipo=wpo')); ?>" class="inline-flex min-h-11 items-center justify-center px-6 py-3 rounded-xl bg-[#E29595] text-slate-950 font-bold hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#E29595] focus-visible:ring-offset-[#121826]">Solicitar una valoración</a></section>
                </section>
