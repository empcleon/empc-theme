        ...
        <article class="max-w-7xl mx-auto px-6 py-20">
            ...
            <?php elseif ($slug === 'consultor-wordpress') : ?>
                <section class="space-y-14">
                    ...
                    <section class="space-y-6"><div class="max-w-3xl space-y-3"><p class="text-[11px] font-bold uppercase tracking-[0.25em] text-[#E29595]">Servicios relacionados</p><h2 class="text-3xl md:text-4xl font-bold text-white">Cada necesidad tiene su página</h2></div><div class="grid md:grid-cols-2 gap-4"><div class="rounded-2xl border border-white/10 bg-[#1F2937]/50 p-5"><h3 class="text-lg font-bold text-white mb-2">Diseño web</h3><p class="text-sm text-slate-400">Para crear o reconstruir una web corporativa, consulta el <a class="text-[#E29595] font-semibold" href="<?php echo esc_url(home_url('/diseno-web-leon/')); ?>">servicio de diseño web</a>.</p></div><div class="rounded-2xl border border-white/10 bg-[#1F2937]/50 p-5"><h3 class="text-lg font-bold text-white mb-2">Mantenimiento WordPress</h3><p class="text-sm text-slate-400">Para revisiones recurrentes de una web ya publicada, consulta el <a class="text-[#E29595] font-semibold" href="<?php echo esc_url(home_url('/mantenimiento-wordpress-leon/')); ?>">mantenimiento WordPress</a>.</p></div></div></section>
